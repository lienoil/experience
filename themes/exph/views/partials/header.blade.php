...
<head>
    ...
    <link rel="stylesheet" href="{{ theme('css/exph.css') }}?v={{ $application->version }}">
    {{-- /Theme Specific --}}
...
<body class="with-backdrop">
    ...
    <script>(function(d, s, id) {
      ...
      js.src = 'https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v3.1&appId=298512730896786&autoLogAppEvents=1';
