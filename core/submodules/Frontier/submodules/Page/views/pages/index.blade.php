            ...
            <v-card class="elevation-1">
                ...
                >
                    ...
                    <template slot="items" scope="prop">
                        ...
                        <td width="40%">
                            <a class="black--text ripple no-decoration" :href="route(urls.pages.show, prop.item.id)">
                               <strong v-tooltip:bottom="{ html: 'Show Detail' }">@{{ prop.item.title }}</strong>
                            </a>
                        </td>
                        <td>@{{ prop.item.slug }}</td>
                        ...
                        <td class="text-xs-center">
                            <v-menu bottom left>
                                ...
                                <v-list>
                                    <v-list-tile ripple :href="route(urls.pages.show, (prop.item.id))">
                                        <v-list-tile-action>
                                    ...
                                    <v-list-tile ripple :href="route(urls.pages.edit, (prop.item.id))">
                                        <v-list-tile-action>
                ...
                return {
                    ...
                    dataset: {
                        ...
                        headers: [
                            ...
                            { text: '{{ __("Code") }}', align: 'left', value: 'schedule' },
                            { text: '{{ __("Created") }}', align: 'left', value: 'updated_at' },
