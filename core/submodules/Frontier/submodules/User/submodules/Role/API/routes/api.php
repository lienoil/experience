...
Route::delete('grants/destroy/{grant}', 'Role\API\Controllers\GrantController@destroy')->name('grants.destroy');
Route::delete('grants/delete/{grant}', 'Role\API\Controllers\GrantController@delete')->name('grants.delete');
...
Route::post('grants/{grant}/restore', 'Role\API\Controllers\GrantController@restore')->name('grants.restore');
