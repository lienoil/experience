...
@section("content")
        ...
        <v-layout row wrap align-end justify-bottom>
            <v-flex xs12>
                <v-card dark class="elevation-0 transparent" row>
                    <v-card-text>
                        <img src="{{ auth()->user()->avatar }}" alt="" height="120">
                        <div class="title">{{ auth()->user()->fullname }}</div>
                        <div class="subheading">Super Administrator</div>
                    </v-card-text>
                </v-card>
            </v-flex xs12>
        </v-layout>
    ...
    <v-card class="elevation-1">
        <v-toolbar class="white elevation-0">
            <v-spacer></v-spacer>
            <v-btn round outline class="purple--text text--lighten-3">Edit Profile</v-btn>
        </v-toolbar>
    </v-card>
