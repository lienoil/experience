<v-slide-y-transition>
    <v-card class="elevation-1 mb-3" v-show="!removetodo" transition="slide-y-transition">
        <v-toolbar class="elevation-1 cyan lighten-1 sortable-handle" dark>
            ...
            <v-menu bottom left>
                ...
                <v-list>
                    <v-list-tile @click="removetodo = !removetodo" ripple>
                        <v-list-tile-action>
                    ...
                    <v-list-tile @click="hidetodo = !hidetodo" ripple>
                        <v-list-tile-action>
                            <v-icon class="grey--text">@{{ hidetodo ? 'visibility' : 'visibility_off' }}</v-icon>
                        </v-list-tile-action>
                        <v-list-tile-content>
                            <v-list-tile-title>
                                @{{ hidetodo ? 'Show' : 'Hide' }}
        ...
        <v-list two-line subheader v-show="!hidetodo">
            ...
            <v-list-tile avatar ripple @click="">
                <v-list-tile-avatar>
                    <v-icon class="cyan white--text">fa fa-book</v-icon>
                </v-list-tile-avatar>
                <v-list-tile-content>
                    <v-list-tile-title>Face-to-face class</v-list-tile-title>
                    <v-list-tile-sub-title>August 30, 2017 9:00AM</v-list-tile-sub-title>
                </v-list-tile-content>
            </v-list-tile>
        </v-list>
    </v-card>
