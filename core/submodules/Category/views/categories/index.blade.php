...
@section("head-title", __('Categories'))

@section("content")
    @include("Theme::partials.banner")
    <v-toolbar dark class="light-blue elevation-1 sticky">
        <v-toolbar-title>{{ __('Categories') }}</v-toolbar-title>
        <v-spacer></v-spacer>
                ...
                <v-slide-y-transition>
                    <v-card class="mb-3 elevation-1" v-show="!hidden" transition="slide-y-transition">
                        <v-toolbar class="transparent elevation-0">
                            <v-toolbar-title class="accent--text">{{ __('New Categories') }}</v-toolbar-title>
                        </v-toolbar>
                                ...
                                <v-layout row wrap>
                                    ...
                                    <v-flex xs8>
                                        <v-text-field
                                            ...
                                            hint="{{ __('Will be used as an ID for Categories. Make sure the code is unique.') }}"
                                            label="{{ _('Code') }}"
                                            name="code"
                                        ></v-text-field>
                                    </v-flex>
