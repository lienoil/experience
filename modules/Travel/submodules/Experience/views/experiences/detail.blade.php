                                    ...
                                    <v-list>
                                        ...
                                        <v-list-tile avatar v-for="(guest, i) in guests" :key="i" class="px-0 py-3">
                                            ...
                                            <v-list-tile-content>
                                                ...
                                                <v-list-tile-sub-title>@{{ guest.birthday }}, @{{ guest.name }}</v-list-tile-sub-title>
                                            </v-list-tile-content>
                                            <v-list-tile-action>
                                        ...
                                        <v-list-tile avatar v-if="guestform.model">
                                            ...
                                            <v-list-tile-content>
                                                <v-text-field ref="guestformbirthday" @input="guestInitial" v-model="guestform.birthday" label="{{ __('Birthday') }}"></v-text-field>
                                            </v-list-tile-content>
                                            <v-list-tile-action>
