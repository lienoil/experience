...
class RoadtripController extends AdminController
{
    ...
    public function all(Request $request)
    {
        ...
        $categories = Category::type('roadtrip')->get();
    ...
    public function create()
    {
        ...
        $categories = Category::type('roadtrip')->select(['name', 'icon', 'id'])->get();
    ...
    public function store(RoadtripRequest $request)
    {
        ...
        $roadtrip->category()->associate(Category::find($request->input('category_id')));
