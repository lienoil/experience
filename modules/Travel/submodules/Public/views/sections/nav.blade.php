    ...
    <v-menu
        ...
        <v-list>
            ...
            <v-list-tile ripple href="stories">
                <v-list-tile-title>Stories from the road</v-list-tile-title>
            </v-list-tile>
            ...
            <v-list-tile ripple href="notifications">
                <v-list-tile-action>
...
<div class="hidden-md-and-down main-nav">
    <v-btn href="experiences" flat>{{ __('Try An Experience') }}</v-btn>
    <v-btn href="roadtrips"flat>{{ __('Join a Road Trip') }}</v-btn>
    <v-btn href="budgets"flat>{{ __('Book a Surprise') }}</v-btn>
    <v-btn href="stories"flat>{{ __('Stories from the Road') }}</v-btn>
    <v-btn href="host" flat success>{{ __('Host an Experience') }}</v-btn>
